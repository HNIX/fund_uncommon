...
class PipelinesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pipeline" do
    assert_difference('Pipeline.count') do
      post pipelines_url, params: { pipeline: { account_id: @pipeline.account_id, name: @pipeline.name, user_id: @pipeline.user_id } }
    end
  ...
  test "should update pipeline" do
    patch pipeline_url(@pipeline), params: { pipeline: { account_id: @pipeline.account_id, name: @pipeline.name, user_id: @pipeline.user_id } }
